...
test("computeProjectInfo indexes app router pages from page.config.ts", async () => {
  ...
  await fs.writeFile(
    ...
    [
      ...
      "          type: \"div\",",
      "          children: [",
      "            { id: \"hero-heading\", type: \"text\", props: { text: \"Hello\" } },",
      "          ],",
      "        },",
      "        { id: \"features-section\", type: \"div\", children: [] },",
      "        { id: \"pricing-section\", type: \"div\", children: [] },",
      "        { id: \"testimonials-section\", type: \"div\", children: [] },",
      "        { id: \"contact-form-section\", type: \"div\", children: [] },",
      "      ],",
      "    },",
      "  ],",
      "};",
